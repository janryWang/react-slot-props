...
var createSlotComponents = function createSlotComponents(Target, relations) {
      ...
      if (isSlot(slot)) {
        if (slot.props) {
          if ((0, _utils.isFn)(slot.props.children)) {
            return (0, _utils.isFn)(render) ? render(slot.props.children, slot.props) : slot.props.children();
          } else {
            return (0, _utils.isFn)(render) ? render(function () {
              return slot.props.children;
            }, slot.props) : slot.props.children;
          }
        }
          ...
          if (isSlot(item)) {
            if (item.props) {
              if ((0, _utils.isFn)(item.props.children)) {
                return (0, _utils.isFn)(render) ? render(item.props.children, item.props, key) : item.props.children(key);
              } else {
                return (0, _utils.isFn)(render) ? render(function () {
                  return item.props.children;
                }, item.props, key) : item.props.children;
              }
            }
          }
        });
  ...
  function (_Component) {
    ...
    _proto.render = function render() {
      ...
      _server.default.renderToStaticMarkup(_react.default.createElement(_utils.DslContext.Provider, {
        value: {
          type: ROOT_TYPE,
      ...
      return _react.default.createElement(_react.default.Fragment, null, function () {
