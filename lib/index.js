...
exports.createSlotComponents = void 0;
...
var createSlotComponents = function createSlotComponents(Target, relations) {
  ...
  var createSlotGetter = function createSlotGetter(slots) {
    return function (path, getter) {
      return (0, _utils.isFn)(getter) ? getter((0, _lodash.default)(slots, path)) : (0, _lodash.default)(slots, path);
    };
  };
